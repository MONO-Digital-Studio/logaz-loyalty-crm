...
const AIAssistantPanel: React.FC = () => {
  ...
  return (
    <div className={`
      fixed bottom-4 right-4 bg-white dark:bg-gray-900 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700
    ...
    `}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-logaz-orange to-orange-500 rounded-t-lg text-white">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-semibold text-sm">ИИ-Ассистент ЛОГАЗ SV</h3>
            ...
            <div className="px-4 py-3 bg-red-50 dark:bg-red-900/20 border-b border-red-200 dark:border-red-800">
              ...
              <div className="space-y-2 max-h-32 overflow-y-auto">
                {criticalInsights.map(insight => (
                  <div key={insight.id} className="text-xs text-red-700 dark:text-red-300 bg-white/50 dark:bg-black/20 rounded p-2">
