...
const mockAgents: Agent[] = [
  {
    ...
    status: 'online',
    activeDialogs: 2,
    skills: ['продажи', 'возвраты', 'консультации'],
  ...
  },
  {
    ...
    status: 'busy',
    activeDialogs: 1,
    skills: ['технические вопросы', 'консультации']
  },
  {
    id: '3',
    ...
    status: 'offline',
    activeDialogs: 0,
    skills: ['продажи', 'лояльность', 'жалобы']
  },
  {
    id: '4',
    name: 'Дмитрий Козлов',
    status: 'online',
    activeDialogs: 3,
    skills: ['технические вопросы', 'возвраты', 'консультации']
  },
];
